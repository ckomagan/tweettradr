<?php 
	...
	if($symbol) { 
		...
		//echo var_dump($SymbolSentiment);
		if($SymbolSentiment[0] >= -1 && $SymbolSentiment[0] <= 1) { $sentiment = 'Neutral'; $color7 = '#0000FF';}
	 	else if($SymbolSentiment[0] > 1) { $sentiment = 'Bullish'; $color7='#00FF00';} else { $sentiment = 'Bearish';$color7 = '#990000';}
		...
		echo '<script type="text/javascript">
			...
			new google.visualization.LineChart(document.getElementById("visualization6")).
					  draw(data6, {curveType: "function",
								  width: 460, height: 130, legendFontSize:10, colors: ['echo $color7;'], legendTextColor: ['echo $color7;'],
